...
class BiharmonicSolver3D:
    ...
    def export_field_grid(self, filename: str, resolution: int = 64) -> str:
        ...
        Args:
            ...
            resolution: разрешение экспортируемой сетки (может быть меньше, чем исходная)
        ...
        # Если нужна пониженная дискретизация
    ...
    def optimize(self, objective='minimize_energy', max_iterations=100, 
        ...
        class Solution:
            def __init__(self, energy, positions, components):
                ...
                self.total_charge = sum(c['charge'] for c in components)
