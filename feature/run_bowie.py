...
with open('data/bowie.json', 'r', encoding='utf-8') as f:
    data = json.load(f)
...
# Боуи прожил 69 лет = ~25200 дней. Прогон с запасом 26000 шагов
total_steps = 26000
print(f"\nЭволюция: {total_steps} шагов (~71 год)...")
...
key_events = {
    "Прорыв Space Oddity": "1969-07-11",
    "Брак с Анджелой": "1970-03-20",
    "Рождение сына Дункана": "1971-05-30",
    "Зигги Стардаст": "1972-06-06",
    "Развод с Анджелой": "1980-02-08",
    "Let's Dance": "1983-04-14",
    "Брак с Иман": "1992-04-24",
    "Рождение дочери": "2000-08-15",
    "Сердечный приступ": "2004-06-25",
    "Смерть": "2016-01-10"
}
