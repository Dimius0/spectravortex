...
2. Make your changes. Write clear commit messages.

3. Run tests to ensure you haven't broken anything.

4. Push your branch to your fork on GitHub.

5. Open a Pull Request (PR) from your branch to the main branch of the main SpectraVortex repository.

6. Describe your changes clearly in the PR description. Link to any related issues.
