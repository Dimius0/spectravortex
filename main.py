...
def run_demo():
    ...
    try:
        # Импортируем и запускаем демо напрямую
        from hardware_backend.component_library import (
            Waveguide, 
            MZIInterferometer, 
            OAMModeConverter
        )
        from hardware_backend.chip_designer import ChipDesigner
        from hardware_backend.gdsii_generator import GDSIIGenerator
